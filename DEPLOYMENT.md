# TD Staking DApp — Setup & Deployment Guide
...
Copy the contract address output and update `.env.local`:
```env
...
Save the contract address and update `.env.local`:
```env
...
**Step 8 (Optional): Verify contract**
```bash
...
- Get testnet ETH/MATIC from faucet
- Verify account has tokens
- Check contract has reward tokens
...
VITE_RPC_URL=https://...        # RPC endpoint for network

# Deployment Configuration
SEPOLIA_RPC_URL=https://...     # Sepolia RPC endpoint
MUMBAI_RPC_URL=https://...      # Mumbai RPC endpoint
...
- **GitHub:** https://github.com/TODD43/td-staking-dapp
...
For issues or questions, visit the [GitHub repository](https://github.com/TODD43/td-staking-dapp).
